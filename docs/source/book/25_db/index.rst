...
**Database (DB)** - data stored according to a certain scheme. This scheme describes relationships between data.
**DB language (language tools)** - used to describe database structure, manage data (add, edit, delete, receive), manage access rights to database and its objects, and manage transactions.
