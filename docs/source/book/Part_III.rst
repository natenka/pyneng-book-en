...
* After processing the output of show version command, you can collect
  information about OS version and uptime.
...
In addition, in network equipment the regular expressions can be used to filter
the output of any show commands.
