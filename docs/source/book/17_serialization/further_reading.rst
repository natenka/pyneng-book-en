...
In this section only basic read and write operations were covered with no
additional parameters. More details can be found in the module documentation.
...
In addition, `PyMOTW <https://pymotw.com/3/index.html>`__ has very good
description of all Python modules that are part of the standard library
